...
.ButtonSecondary {
  ...
  & .ButtonSecondary__accent {
    ...
    transition: transform $modifer-duration, background-color $modifer-duration,
      box-shadow $modifer-duration;
  }
  ...
  & .ButtonSecondary__accent-left {
    ...
    box-shadow: -2px 0px 4px 0px
      color-link("ButtonSecondary", "accent", "secondary", 0.4);
  }
  ...
  &:active:not(.disabled) {
    ...
    & .ButtonSecondary__accent-left {
      ...
      box-shadow: -2px 0px 4px 0px
        color-link("ButtonSecondary", "selected", "primary", 0.4);
    }
